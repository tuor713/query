                ...
                <div class="setting-group">
                    <label for="memory">
                        ...
                        <span class="label-hint">
                            (AI stores user preferences, feedback, and context here)
                        </span>
                    </label>
                    <textarea
                        id="memory"
                        bind:value={tempMemory}
                        placeholder="No memory stored yet. The AI will create and update this document as you interact..."
                        rows="20"
                    ></textarea>
                </div>
            </div>
